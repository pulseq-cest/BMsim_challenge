...
Figures referenced in `text/bmsim.tex`:

- `All_Cases_Z_and_MTRasym_ref.png` / `.pdf`
- `Figure_CASE_12.png`, `Figure_CASE_34.png`, `Figure_CASE_56.png`, `Figure_CASE_78.png`
- `Case_3_zMT_comparison.png`
- `Figure_numerical_checks.png` / `.pdf`

`Pulses.pdf` is maintained separately (not generated by these scripts).

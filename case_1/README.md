...
## Pool model:
The pool model of case 1 is identical to the [z_phantom_creatine_3T_pH6.4_T22C_bmsim](https://github.com/kherz/pulseq-cest-library/blob/6ffca73282badd2828b86ace383969e9b4276e80/sim-library/z_phantom_creatine_3T_pH6.4_T22C_bmsim.yaml)
...
but with 15 seconds of saturation to approach steady state (water T1 = 3 s; deviation from steady state < 10^-4 for the CEST pool with T1 = 1.05 s)

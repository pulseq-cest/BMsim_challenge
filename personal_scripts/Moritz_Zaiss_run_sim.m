...
seq_filename=fullfile(lib_path,'/sandbox/001_realisticAPTw/WASABI_3T_001_3p7uT_1block_5ms.seq')

% read the .seq-file

file_list= {
    'WM_3T_default_7pool_bmsim.yaml'
    'z_phantom_creatine_3T_pH6.4_T22C_bmsim.yaml'
    };

%% 1
figure('Name','APTw_000 WM');
seq_filename=fullfile(seq_path,'/APTw_3T_000_2uT_1block_2s_braintumor/APTw_3T_000_2uT_1block_2s_braintumor.seq')
